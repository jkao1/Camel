 ...
 * @url http://stackoverflow.com/questions/14186955/create-a-autocompleting-textbox-in-java-with-a-dropdown-list
 */
...
public class AutoSuggestor {
    ...
    private void showPopUpWindow() {
        ...
        autoSuggestionPopUpWindow.setLocation(windowX+94, windowY+85);
        autoSuggestionPopUpWindow.setMinimumSize(new Dimension(textField.getWidth(), 30));
